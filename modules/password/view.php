        ...
        <form role="form" class="form-horizontal" method="POST" action="modules/password/proses.php">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="password" class="form-control clave" name="new_pass" autocomplete="off" required> 
                <span class="mensaje text-danger "></span>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="password" class="form-control confirmar" name="retype_pass" autocomplete="off" required>
                <span class="mensaje1 text-danger "></span>
              </div>
